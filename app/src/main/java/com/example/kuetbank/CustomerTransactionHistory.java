...
public class CustomerTransactionHistory extends AppCompatActivity implements SelectListener4 {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        database.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                myAdapter = new TransAdapter(CustomerTransactionHistory.this,list,CustomerTransactionHistory.this);
                recyclerView.setAdapter(myAdapter);
                }
                else{
                    Toast.makeText(CustomerTransactionHistory.this, "NO Transaction", Toast.LENGTH_SHORT).show();
                }
            }
    ...
    public void onBackPressed(){
        Intent intent=new Intent(CustomerTransactionHistory.this,CustomerHome.class);
