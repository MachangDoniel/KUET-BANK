...
public class CustomerPayment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dataBaseReference.child("users").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.hasChild(ACC)){
                    ...
                    Toast.makeText(CustomerPayment.this,"Account No doesn't exists",Toast.LENGTH_SHORT).show();
                }
            }
        ...
        profile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(CustomerPayment.this,CustomerProfile.class);
        ...
        transfer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(CustomerPayment.this,CustomerTransfer.class);
                intent.putExtra("Account_No",ACC);
                startActivity(intent);
            }
        });
        ...
        payment.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(CustomerPayment.this,CustomerPayment.class);
                intent.putExtra("Account_No",ACC);
                startActivity(intent);
            }
        });
        ...
        loan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(CustomerPayment.this,CustomerLoan.class);
                intent.putExtra("Account_No",ACC);
                startActivity(intent);
            }
        });
    ...
    public void onBackPressed(){
        startActivity(new Intent(CustomerPayment.this,CustomerHome.class));
    }
}